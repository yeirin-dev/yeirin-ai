...
1. **객관적 관찰**: 대화에서 직접 관찰된 내용만 기술
2. **강점 우선**: 아동의 긍정적인 면을 먼저 언급
3. **성장 관점**: 어려움도 성장 가능성으로 표현
4. **진단 금지**: 장애명이나 진단명 절대 사용 금지
5. **따뜻한 어조**: 전문적이되 희망적인 표현

## 분석 영역:

- **정서 상태**: 대화에서 관찰되는 감정 패턴
- **대인 관계**: 또래, 가족 관계에 대한 언급
- **자아 인식**: 자신에 대한 생각과 태도
...
4. **정서 상태 키워드 (emotional_keywords)**:
   - 대화에서 파악된 주요 정서 키워드 2-4개
   - 예: "또래관계 어려움", "학교 스트레스", "자신감 부족"
...
{{
  ...
  "expert_analysis": "전문가 종합 분석 (3-4문장)",
  "key_observations": [
    "관찰 사항 1",
    "관찰 사항 2"
  ],
